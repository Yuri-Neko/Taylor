...
await conn.sendFile(m.chat, imgr + 'inventory', '', str, m, { mentions: conn.parseMention(str) })
} else if (args[0] == '2') {
// Inventory 2
...
`.trim()
await conn.sendFile(m.chat, imgr + 'inventory', '', caption, m, { mentions: conn.parseMention(caption) })
} else if (args[0] == '3') {
// Inventory 3
...
await conn.sendFile(m.chat, imgr + 'inventory', '', aineh, m, { mentions: conn.parseMention(aineh) })
}
