...
await conn.sendFile(m.chat, await man1(one), "", "*[ Result ]*", m)
}
if (command == "canvasman2") {
await conn.sendFile(m.chat, await man2(one), "", "*[ Result ]*", m)
}
if (command == "canvasman3") {
await conn.sendFile(m.chat, await man3(one), "", "*[ Result ]*", m)
}
if (command == "canvasman3") {
await conn.sendFile(m.chat, await bolsonero(one), "", "*[ Result ]*", m)
}
if (command == "canvasbriggs") {
await conn.sendFile(m.chat, await briggs(one), "", "*[ Result ]*", m)
}
if (command == "canvasdrake") {
await conn.sendFile(m.chat, await drake(one, two), "", "*[ Result ]*", m)
}
if (command == "canvasdo1") {
await conn.sendFile(m.chat, await ednaldoBandeira(one), "", "*[ Result ]*", m)
}
if (command == "canvasdo2") {
await conn.sendFile(m.chat, await ednaldoTV(one), "", "*[ Result ]*", m)
}
if (command == "canvasimgedit") {
await conn.sendFile(m.chat, await imgEditor(one, two, three, four), "", "*[ Result ]*", m)
}
if (command == "canvasinvert") {
await conn.sendFile(m.chat, await invert(one), "", "*[ Result ]*", m)
}
if (command == "canvasjooj") {
await conn.sendFile(m.chat, await jooj(one), "", "*[ Result ]*", m)
}
if (command == "canvasmark") {
await conn.sendFile(m.chat, await markSuckerberg(one), "", "*[ Result ]*", m)
}
if (command == "canvasmedal") {
await conn.sendFile(m.chat, await medal(one, two), "", "*[ Result ]*", m)
}
if (command == "canvasmario") {
await conn.sendFile(m.chat, await morrepraga(one), "", "*[ Result ]*", m)
}
if (command == "canvasojjo") {
await conn.sendFile(m.chat, await ojjo(one), "", "*[ Result ]*", m)
}
if (command == "canvaspaper") {
await conn.sendFile(m.chat, await paper(one), "", "*[ Result ]*", m)
}
if (command == "canvasfrog") {
await conn.sendFile(m.chat, await pepe(one), "", "*[ Result ]*", m)
}
if (command == "canvasromero") {
await conn.sendFile(m.chat, await romero(one), "", "*[ Result ]*", m)
}
if (command == "canvastv") {
await conn.sendFile(m.chat, await shotTV(one), "", "*[ Result ]*", m)
}
if (command == "canvassponge") {
await conn.sendFile(m.chat, await sponge(one), "", "*[ Result ]*", m)
}
if (command == "canvasttp") {
await conn.sendFile(m.chat, await ttp(one, two, three), "", "*[ Result ]*", m)
}
if (command == "canvaswolverine") {
await conn.sendFile(m.chat, await wolverine(one), "", "*[ Result ]*", m)
}
} catch (e) {
throw eror
}
